...
const DirectMortgageLoginEnhanced = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if (formSubmitted) {
      setValidation({
        emailOrPhone: validateEmailOrPhone(value)
      });
    }
  };
      ...
      const progressInterval = setInterval(() => {
        setProgress(prevProgress => {
          ...
          if (newProgress >= 100) {
            ...
            // Ensure minimum loading time of 1.5 seconds for UX
            ...
            <form onSubmit={handleSubmit} role="form" aria-labelledby="form-title">
              <div className={`form-group ${!validation.emailOrPhone.isValid ? 'has-error' : ''}`}>
                ...
                <input
                  ...
                  placeholder="name@example.com or (555) 555-555"
                  inputMode="email"
                  required
                  aria-required="true"
...
export default DirectMortgageLoginEnhanced;
